...
#' May, June; Summer = July, August, September. Methods used to derive these data are available at \url{https://github.com/NOAA-EDAB/ecodata24/blob/master/data-raw/get_seasonal_oisst_anom.R}.
